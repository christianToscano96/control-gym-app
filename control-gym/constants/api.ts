// Para saber tu IP local, ejecuta en terminal: ifconfig | grep "inet " | grep -v 127.0.0.1
// Opciones:
// - localhost (para emulador Android en Mac o simulador iOS): "http://localhost:4000"
