...
export default function EditProfile() {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      // await updateProfile({ fullName, email, phone, jobTitle });
      ...
      >
        ...
        <View className="items-center justify-center py-8">
          <View className="relative">
            ...
            >
              <MaterialIcons name="photo-camera" size={20} color="#0d1c3d" />
            </TouchableOpacity>
          </View>
        ...
        <View className="px-4 pb-6">
          ...
          <TextField
            ...
            leftIcon={<MaterialIcons name="badge" size={20} color="#9CA3AF" />}
          />
        </View>
      </ScrollView>
      {/* Action Buttons */}
